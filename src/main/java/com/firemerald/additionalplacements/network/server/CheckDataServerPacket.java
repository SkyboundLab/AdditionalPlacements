...
public class CheckDataServerPacket extends ServerLoginPacket
{
	...
	@Override
	public void handleServer(MinecraftServer server, ServerLoginPacketListenerImpl handler, boolean understood, LoginSynchronizer synchronizer, PacketSender responseSender) {
		...
		if (!compiledErrors.isEmpty()) {
			...
			handler.disconnect(Component.translatable("msg.additionalplacements.disconnected"));
		}
